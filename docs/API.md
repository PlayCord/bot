...
PlayCord uses a component-based architecture where games inherit from the `Game` base class and implement required methods. The framework handles Discord integration, turn management, and rating updates.
