...
from playcord.discord_games.game import RoleMode
from playcord.discord_games.player import Player
from playcord import state as session_state
from playcord.infrastructure.app_constants import LONG_SPACE_EMBED, MU
...
async def game_over(
    ...
    if isinstance(outcome, str):
        ...
        try:
            await outbound_message.edit(**container_edit_kwargs(error_text))
        except Exception:
            try:
