...
from playcord.discord_games.game import Game as BaseGame
...
from playcord.utils.containers import GameOverviewContainer
from playcord.utils.conversion import column_elo, column_turn
from playcord.utils.locale import fmt, get
from playcord.utils.views import SpectateView
...
def build_game_info_message(
    *,
    ...
    return Message(
        Container(
            TextDisplay(
                f"## {fmt('game.state_title', game=game_name, players=len(players))}"
            ),
