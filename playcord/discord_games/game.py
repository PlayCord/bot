...
from playcord.discord_games.message_components import Message, ThreadMessage
...
class Game(ABC):
    ...
    # Lobby selects before start; tuple of MatchOptionSpec (see playcord.domain.match_options)
    ...
    def seat_players(
        ...
        Operates on :class:`~playcord.utils.database.InternalPlayer` / :class:`playcord.discord_games.player.Player` before the game instance exists.
        """
